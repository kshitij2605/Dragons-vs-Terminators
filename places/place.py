...
class Place(object):
            ...
            if self.dragon is None:
                ...
                if fighter.is_container:
                    if not self.dragon.is_container:
                        ...
                        # END 3.2
                elif not fighter.is_container:
                    if self.dragon.is_container and self.dragon.contained_dragon is None:
    ...
    def remove_fighter(self, fighter):
        ...
        if fighter.is_dragon:
            ...
            # BEGIN 4.3
            if isinstance(fighter, DragonKing)  and fighter.instantiated is True:
                pass
            # END 4.3
